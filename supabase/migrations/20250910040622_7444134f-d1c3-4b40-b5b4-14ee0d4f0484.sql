...
-- 5. Insérer des données de test pour valider le fonctionnement
...
INSERT INTO public.ads (id, campaign_id, title, content, type, reward_points, reward_amount, image_url, status) VALUES
  ...
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '22222222-2222-2222-2222-222222222222', 'Innovation tech', 'Découvrez l\'avenir de la technologie.', 'audio', 30, 0.03, '/lovable-uploads/04282974-27aa-4e80-9818-043448844ed9.png', 'active')
ON CONFLICT (id) DO NOTHING;